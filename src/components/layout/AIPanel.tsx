            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                    <div className="flex items-start">
                        ...
                        <div>
                            <p className="text-xs font-medium text-amber-400 mb-1">{t('aipanel.syncWarningTitle')}</p>
                            <p className="text-xs text-gray-400">{t('aipanel.syncWarning')}</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <button className="w-full flex items-center justify-center py-2.5 px-4 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-400 text-sm font-medium border border-indigo-500/30 rounded-lg transition-colors group">
                        ...
                        {t('aipanel.updateAnalysis')}
                    </button>
                </div>

                {/* AI Notes Mockup */}
                <div>
                    <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">{t('aipanel.notesTitle')}</h3>

                    <div className="space-y-4">
                        <div className="bg-gray-800/50 rounded-lg p-3">
                            <h4 className="text-xs font-semibold text-gray-300 mb-1">{t('aipanel.note1Title')}</h4>
                            <p className="text-xs text-gray-400">{t('aipanel.note1Desc')}</p>
                        </div>

                        <div className="bg-gray-800/50 rounded-lg p-3">
                            <h4 className="text-xs font-semibold text-gray-300 mb-1">{t('aipanel.note2Title')}</h4>
                            <p className="text-xs text-gray-400">{t('aipanel.note2Desc')}</p>
                        </div>
                    </div>
                </div>
